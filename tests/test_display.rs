...
fn test_braced() {
    ...
    let msg = "T".to_owned();
    assert("braced error: T", Error { msg: msg.clone() });
    assert_eq_file!(Ec::new(Error { msg }).to_string());
}
...
fn test_braced_unused() {
    ...
    assert_eq_file!(Ec::new(Error { extra: 0 }).to_string());
}
...
fn test_tuple() {
    ...
    assert_eq_file!(Ec::new(Error(0)).to_string());
}
...
fn test_unit() {
    ...
    assert_eq_file!(Ec::new(Error).to_string());
}
...
fn test_enum() {
    ...
    assert_eq_file!(
        Ec::new(Error::Braced { id: 0 }).to_string(),
        Ec::new(Error::Tuple(0)).to_string(),
        Ec::new(Error::Unit).to_string()
    );
}
...
fn test_constants() {
    ...
    assert_eq_file!(Ec::new(Error { id: "" }).to_string());
}
...
fn test_inherit() {
    ...
    assert_eq_file!(
        Ec::new(Error::Some("some error")).to_string(),
        Ec::new(Error::Other("...")).to_string()
    );
}
...
fn test_nested() {
    ...
    assert_eq_file!(Ec::new(Error(true)).to_string());
}
...
fn test_match() {
    ...
    assert_eq_file!(
        Ec::new(Error("...".to_owned(), Some(1))).to_string(),
        Ec::new(Error("...".to_owned(), None)).to_string()
    );
}
...
fn test_mixed() {
    ...
    assert_eq_file!(Ec::new(Error { a: 0, d: 0 }).to_string());
}
...
fn test_ints() {
    ...
    assert_eq_file!(
        Ec::new(Error::Tuple(9, 0)).to_string(),
        Ec::new(Error::Struct { v: 0 }).to_string()
    );
}
...
fn test_field() {
    ...
    assert_eq_file!(Ec::new(Error(Inner { data: 0 })).to_string());
}
...
fn test_nested_tuple_field() {
    ...
    assert_eq_file!(Ec::new(Error(Inner(0))).to_string());
}
...
fn test_macro_rules() {
    ...
    assert("0", a::Error0::Repro(0));
    assert("0", b::Error1::Repro(0));
    assert_eq_file!(
        a::Ec::new(a::Error0::Repro(0)).to_string(),
        b::Ec::new(b::Error1::Repro(0)).to_string()
    );
}
...
fn test_raw() {
    ...
    assert_eq_file!(Ec::new(Error { r#fn: "T" }).to_string());
}
...
fn test_raw_enum() {
    ...
    assert_eq_file!(Ec::new(Error::Braced { r#fn: "T" }).to_string());
}
...
fn test_raw_conflict() {
    ...
    assert_eq_file!(Ec::new(Error::Braced { r#func: "T" }).to_string());
}
