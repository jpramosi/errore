...
impl<'a> Input<'a> {
    pub fn from_syn(node: &'a DeriveInput, derive: DeriveType) -> Result<Self> {
        match &node.data {
            Data::Struct(data) => Struct::from_syn(node, data, derive).map(Input::Struct),
            Data::Enum(data) => Enum::from_syn(node, data, derive).map(Input::Enum),
...
impl<'a> Struct<'a> {
    fn from_syn(node: &'a DeriveInput, data: &'a DataStruct, derive: DeriveType) -> Result<Self> {
...
impl<'a> Enum<'a> {
    fn from_syn(node: &'a DeriveInput, data: &'a DataEnum, derive: DeriveType) -> Result<Self> {
